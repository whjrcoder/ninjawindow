...
ninja= createSprite(150, windowHeight-180, 50, 50);
...
inviground=createSprite(windowWidth/2,windowHeight-130,4*windowWidth,5)
inviground.visible=false

 
roofgroup=createGroup();
for(i=ninja.x+410;i<10000;i=i+800){
  roof=createSprite(i,windowHeight/2,460,10)
  roof.visible=false
  roofgroup.add(roof)
  console.log(roof.x)
  i=i+50;
...
restart=createSprite(windowWidth/2,windowHeight/2,250,150)

icon=createSprite(windowWidth/2,windowHeight/2)
icon.visible=false

oversprite=createSprite(windowWidth/2,windowHeight/2)
...
inviground.x=50
inviground.width=windowWidth/2+100;
...
textSize(50)
fill("gold")
text("COINS "+score,ninja.x+800,windowHeight/2-200)
...
function blackvillan(){
  ...
  if(frameCount%100===0){
    fighter=createSprite(ninja.x+800,windowHeight-450)
...
function turtle(){
  ...
  if(frameCount%i===0){
villan=createSprite(random(windowWidth-10,windowWidth-100),windowHeight-250)
